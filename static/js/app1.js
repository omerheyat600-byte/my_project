...
const THEMES = {
    modern: {
        css: `
            ...
            .card-modern .logo-section { flex-shrink: 0; width: 90px; height: 90px; overflow: hidden; border-radius: 50%; border: 2px solid #0f172a; background: #fff; display: flex; align-items: center; justify-content: center; }
            .card-modern .logo-section img { width: 100%; height: 100%; object-fit: contain; }
            .card-modern .header-text { flex: 1; }
            .card-modern .school-title { font-size: 32px; font-weight: 800; color: #0f172a; margin: 0; text-transform: uppercase; letter-spacing: 0.5px; }
            .card-modern .school-sub { font-size: 15px; color: #64748b; margin: 4px 0 0 0; font-weight: 500; }
            .card-modern .badge-title { display: inline-block; background: #0f172a; color: #fff; padding: 6px 28px; font-weight: 700; font-size: 14px; text-transform: uppercase; border-radius: 30px; margin-top: 10px; }
                ...
                <div class="card-modern">
                    <div class="header">
                        ...
                        <div class="header-text">
                            <div class="school-title">Zain Science Acadmy</div>
    ...
    classic: {
        css: `
            ...
            .card-classic .school-header { display: flex; align-items: center; gap: 28px; margin-bottom: 28px; }
            .card-classic .logo-section { flex-shrink: 0; width: 90px; height: 90px; overflow: hidden; border: 1px solid #1e3a8a; border-radius: 50%; background: #fff; display: flex; align-items: center; justify-content: center; }
            .card-classic .logo-section img { width: 100%; height: 100%; object-fit: contain; }
            .card-classic .header-text { flex: 1; }
            .card-classic .school-name { font-size: 34px; font-weight: bold; color: #1e3a8a; font-family: 'Times New Roman', serif; margin: 0; }
            .card-classic .sub-heading { font-size: 14px; font-style: italic; color: #555; margin-top: 4px; text-transform: uppercase; letter-spacing: 1px; }
            .card-classic .title { font-size: 18px; font-weight: bold; margin-top: 12px; text-transform: uppercase; letter-spacing: 2px; color: #1e3a8a; border-bottom: 2px solid #1e3a8a; display: inline-block; padding-bottom: 4px; }
                    ...
                    <div class="outer-border">
                        <div class="inner-border">
                            <div class="school-header">
                                ...
                                <div class="header-text">
                                    <div class="school-name">Zain Science Acadmy</div>
    ...
    minimalist: {
        css: `
            ...
            .card-minimalist .logo-section { flex-shrink: 0; width: 78px; height: 78px; overflow: hidden; border-radius: 50%; background: #fff; display: flex; align-items: center; justify-content: center; border: 1px solid #e2e8f0; }
            .card-minimalist .logo-section img { width: 100%; height: 100%; object-fit: contain; }
            ...
            return `
                <div class="card-minimalist">
                    <div class="header-flex">
                        ...
                        <div>
                            <div class="school-main">Zain Science Acadmy <span class="report-tag">Report Card</span></div>
    ...
    'slate-grid': {
        css: `
            ...
            .card-slate-grid .logo-section { width: 90px; height: 90px; margin: 0 auto 12px; overflow: hidden; border-radius: 50%; border: 2px solid #38bdf8; background: #fff; display: flex; align-items: center; justify-content: center; }
            .card-slate-grid .logo-section img { width: 100%; height: 100%; object-fit: contain; }
    ...
    'royal-emblem': {
        css: `
            ...
            .card-royal .logo-section { flex-shrink: 0; width: 90px; height: 90px; overflow: hidden; border-radius: 50%; border: 2px solid #b45309; background: #fff; display: flex; align-items: center; justify-content: center; }
            .card-royal .logo-section img { width: 100%; height: 100%; object-fit: contain; }
    ...
    css: `
        ...
        .card-diagonal .logo-section { position: relative; z-index: 2; width: 80px; height: 80px; background: #ffffff; border-radius: 50%; border: 3px solid #3498db; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; }
        .card-diagonal .logo-section img { width: 100%; height: 100%; object-fit: cover; border-radius: 50%; }
    ...
    try {
        ...
        studentsToRender.forEach(student => {
            ...
            subjectsList.forEach(subjectItem => {
                ...
                if (match) {
                    obtained = parseInt(match.obtained_marks || 0);
                    total = parseInt(match.total_marks || 100);
